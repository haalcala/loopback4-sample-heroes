...
export class PlanetController {
  ...
  async count(
    @param.query.object('where', getWhereSchemaFor(Planet)) where?: Where<Planet>,
  ): Promise<Count> {
  ...
  async find(
    @param.query.object('filter', getFilterSchemaFor(Planet)) filter?: Filter<Planet>,
  ): Promise<Planet[]> {
  ...
  async replaceById(
    ...
    await this.planetRepository.replaceById(id, planet);
  }
