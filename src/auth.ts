import { MethodDecoratorFactory, inject, CoreBindings, Constructor, MetadataInspector, Provider, ValueOrPromise, Getter, Setter, BindingKey } from "@loopback/core";
import { AUTHENTICATION_METADATA_KEY, AuthenticationMetadata, AuthenticationBindings, UserProfile, AuthenticateFn, StrategyAdapter } from "@loopback/authentication";
...
export class MyAuthMetadataProvider extends AuthMetadataProvider {
	...
	value(): MyAuthenticationMetadata | undefined {
		...
		return MetadataInspector.getMethodMetadata<MyAuthenticationMetadata>(AUTHENTICATION_METADATA_KEY, this._controllerClass.prototype, this._methodName);
	}
}
