...
import { MyAuthBindings, MyAuthMetadataProvider, MyAuthStrategyProvider, MyAuthActionProvider } from "./auth";

export class HeroesApplication extends BootMixin(ServiceMixin(RepositoryMixin(RestApplication))) {
